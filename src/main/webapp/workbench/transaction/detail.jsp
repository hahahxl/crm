<%@ page import="com.bytedance.crm.setting.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.bytedance.crm.workbench.domain.Tran" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function showHistoryList() {
            $.ajax({
                url: "${pageContext.request.contextPath}/workbench/transaction/getHistoryList.do",
                type: "get",
                dataType: "json",
                data: {
                    "tranId": "${tran.id}"
        ...
        function changeStage(stage, i) {
            $.ajax({
                url: "${pageContext.request.contextPath}/workbench/transaction/changeStage.do",
                type: "get",
                dataType: "json",
                data: {
                    "id": "${tran.id}",
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
        ...
        for (int i = 0; i < dicValueList.size(); i++) {
            DicValue dicValue = dicValueList.get(i);
            String stage = dicValue.getValue();
            String possinility = pmap.get(stage);
            if ("0".equals(possinility)) {
                    /*说明是黑叉*/
                //黑叉-----------------
    %>
